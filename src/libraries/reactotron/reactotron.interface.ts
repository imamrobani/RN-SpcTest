...
import {ClientOptions} from 'reactotron-react-native';
...
export interface Reactotron<ReactotronSubtype = ReactotronCore>
  extends ReactotronCore {
  /**
   * Set the configuration options.
   */
  configure: (
    options?: ClientOptions<ReactotronSubtype>,
